	...
	if( $('.slideshow').length > 0 ) {
		$.supersized({
			...
			slides:  	[				// Slideshow Images
							{image : 'assets/img/sliders/slider1.png', title : '<div class="hero-text"><h2 class="hero-heading">Design</h2><p>Building beautiful, standards compliant UI.</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider2.png', title : '<div class="hero-text"><h2 class="hero-heading">Code</h2><p>Hand written, clean, semantic code.</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider3.png', title : '<div class="hero-text"><h2 class="hero-heading">Branding</h2><p>Fresh campaigns to promote your company.</p></div>', thumb : '', url : ''}  
						],
		});
